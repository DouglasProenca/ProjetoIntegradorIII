 ...
 * @author Camil
 */
public class consultarColaboradores extends javax.swing.JFrame {

    /**
     * Creates new form consultarColaboradores
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultarColaboradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultarColaboradores().setVisible(true);
            }
        });
    }
